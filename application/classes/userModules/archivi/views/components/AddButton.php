<?php
class archivi_views_components_AddButton extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
        ...
        $routeUrl = explode(',', $this->getAttribute('routeUrl'));
        ...
        foreach ($types as $i => $type) {
            $output .= '<li>'.__Link::makeLink($routeUrl[$i], array('sectionType' => $type, 'id' => 0, 'label' => 'Crea scheda: '.$labels[$i])).'</li>';
        }
