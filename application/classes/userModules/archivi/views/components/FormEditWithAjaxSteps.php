<?php
class archivi_views_components_FormEditWithAjaxSteps extends pinaxcms_views_components_FormEdit
{
	public function render_html_onStart()
	{
        ...
        $childJs1 = __ObjectFactory::createComponent('pinax.components.JSscript', $this->_application, $this, 'glz:JSscript', 'js1');
