<?php
class archivi_models_vo_DocumentObjectVO extends pinax_dataAccessDoctrine_vo_DocumentObjectVO
{
    function __construct($data)
    {
        $languageProxy = pinax_ObjectFactory::createObject('pinaxcms.languages.models.proxy.LanguagesProxy');
