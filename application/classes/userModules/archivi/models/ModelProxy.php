<?php
class archivi_models_ModelProxy extends PinaxObject
{
    /**
     * @param $fieldName
     * @param $model
     ...
     * @return array
     */
    protected function createArrayFromIterator($it)
    {
        $i = 0;
     ...
     * @return array
     */
    protected function sortResultsByText($result)
    {
    ...
    protected function shouldFilterByInstitute($model, $instKey){
        $viewAll = array(
