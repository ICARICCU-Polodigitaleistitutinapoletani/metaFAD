    ...
    protected function createNodeFromDoc($doc, $hasChildren)
    {
       ...
       //$denominazione = truncateDenominazioneDoc($denominazione);
        ...
        $node = array(
            ...
            'canImport' => $doc->document_type_t[0] == 'archivi.models.ComplessoArchivistico' ? true : false,
            'canExport' => $doc->document_type_t[0] == 'archivi.models.ComplessoArchivistico' ? true : false,
