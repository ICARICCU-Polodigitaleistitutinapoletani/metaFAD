...
class archivi_services_VisibilityService extends metafad_jobmanager_service_JobService
{
    ...
    public function run()
    {
        try {
            ...
            $this->arcProxy = pinax_ObjectFactory::createModel("archivi.models.proxy.ArchiviProxy");
            $this->visHelper = pinax_ObjectFactory::createObject('metafad_common_helpers_VisibilityHelper');
    ...
    {
        $this->visHelper = $this->visHelper ?: pinax_ObjectFactory::createObject('metafad_common_helpers_VisibilityHelper');
    ...
    public function getAllSubIDs($root, $container = array())
    {
        ...
        $it = pinax_ObjectFactory::createModelIterator('archivi.models.Model')
            ->load('getParent', array(':parent' => $root->__id, ':languageId' => pinax_ObjectValues::get('org.pinax', 'languageId')));
    ...
    {
        $it = pinax_ObjectFactory::createModelIterator('archivi.models.Model')
            ->load('getParent', array(':parent' => $padre->__id, ':languageId' => pinax_ObjectValues::get('org.pinax', 'languageId')));
