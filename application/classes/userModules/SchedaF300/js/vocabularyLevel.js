$(document).ready(function(){
    Pinax.events.on("pinaxcms.formEdit.onReady", function(){
        $.each([['PVCS','PVCR'],['PVCR','PVCP'],['PVCP','PVCC'],['PVCC','PVCL'],['LDCT','LDCQ'],['PRVS','PRVR'],['PRVR','PRVP'],['PRVP','PRVC'],['PRVC','PRVL'],['PRCT','PRCQ'],['LRCS','LRCR'],['LRCR','LRCP'],['LRCP','LRCC'],['LRCC','LRCL'],['ADSP','ADSM']], function(i, item){
            if ($('#'+item[0]).val()) {
