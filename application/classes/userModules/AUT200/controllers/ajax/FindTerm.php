<?php
class AUT200_controllers_ajax_FindTerm extends metafad_common_controllers_ajax_CommandAjax
{
    public function execute($fieldName, $model, $term, $id)
    {
        ...
        $it = pinax_ObjectFactory::createModelIterator('AUT200.models.Model');
