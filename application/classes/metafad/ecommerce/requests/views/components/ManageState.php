<?php
class metafad_ecommerce_requests_views_components_ManageState extends pinax_components_Component
{
    function init()
    {
    ...
    public function render($outputMode=NULL, $skipChilds=false)
    {
      ...
      if($id)
      {
        $ar = pinax_ObjectFactory::createModel('metafad.ecommerce.requests.models.Model');
        if($ar->load($id))
        {
      ...
      $flowsFile = pinax_findClassPath('metafad/ecommerce/requests/json/flows.json', false, false);
