<?php
class metafad_ecommerce_orders_controllers_Edit extends pinaxcms_contents_controllers_activeRecordEdit_Edit
{
  public function execute($id)
  {
    if ($id) {
      $order = pinax_ObjectFactory::createModel('metafad.ecommerce.orders.models.Model');
      if($order->load($id))
      {
