<?php
class metafad_ecommerce_orders_views_components_OrderObjects extends pinax_components_Component
{
    private $helper;
    ...
    {
      $this->helper = pinax_ObjectFactory::createModel('metafad.ecommerce.requests.views.helpers.ObjectInfoHelper');

      $id = __Request::get('id',null);
      if($id)
      {
        $priceTotal = 0;
        $items = pinax_ObjectFactory::createModelIterator('metafad.ecommerce.orders.models.Item')
