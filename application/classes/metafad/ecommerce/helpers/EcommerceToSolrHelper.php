<?php
class metafad_ecommerce_helpers_EcommerceToSolrHelper extends PinaxObject
{
  ...
  public function getEcommerceInfo($data,$type)
  {
    ...
    $media = null;
    $ecommerce = null;
    $this->licenseProxy = pinax_ObjectFactory::createObject('metafad_ecommerce_licenses_models_proxy_LicensesProxy');
